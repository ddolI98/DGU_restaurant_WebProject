...
//        restID = (String) request.getParameter("serialNum");
//    }
    ...
    String[] storeInfo = storedao.getStoreInfo(restID);
...
<h6 style="text-align:center;"><strong><%=explane %></strong></h6>
...
<div style="width:70%; height:auto; float:left; ">
    <div style="padding-left: 30%; margin-top: 50px;">
        ...
        전화번호: <%=phoneNumber %><br>
        주소: <%=address %><br>
        영업 시간: <%=startHours %> 부터 <%=endHours %><br>
        휴무: <%=holiday %><br>
    </div>
