...
<head>
    ...
    <style>
        .nav-pills .nav-link.active,.nav-pills .show>.nav-link {
            color:#fff;background-color:#FAF1D6
        }
    </style>
</head>
<body>
...
<div class="tab-content container justify-content-center" id="nav-tabContent" style="max-width: 1000px">
            ...
            <div class="container col-8">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="postCode" id="postCode" value="<%=(String)session.getAttribute("userAddress")%>" style="margin-right: 10px" required>
                    </div>
